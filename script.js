...
const searchBtn = document.getElementById('searchingBtn');
...
async function checkWeather(city){
    const api_key ="6f363202c69a155d3739e5a6a8c912de";
    ...
    switch(weather_data.weather[1].main){
        case 'Clouds':
